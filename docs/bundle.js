...
},{"./wrapMapToProps":45,"redux":61}],41:[function(require,module,exports){
'use strict';
...
},{"./createStore":60,"./utils/warning":62,"_process":28,"lodash/isPlainObject":26}],59:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":26,"symbol-observable":63}],61:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":56,"./bindActionCreators":57,"./combineReducers":58,"./compose":59,"./createStore":60,"./utils/warning":62,"_process":28}],62:[function(require,module,exports){
'use strict';
...
},{"react":54}],66:[function(require,module,exports){
'use strict';
      ...
      return _react2.default.createElement(
        ...
        packages.map(function (pkg, i) {
          return _react2.default.createElement(
            'li',
            null,
            _react2.default.createElement(_Chart2.default, { key: i, pkg: pkg })
          );
        })
      );
    }
...
},{"./Chart":65,"react":54}],67:[function(require,module,exports){
'use strict';
...
},{"../components/Root":66,"react-redux":46}],68:[function(require,module,exports){
'use strict';
...
},{"./packages":69,"redux":61}],69:[function(require,module,exports){
'use strict';
...
function packages() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _initialState2.default.packages;
  var action = arguments[1];
...
},{"../store/initialState":72}],70:[function(require,module,exports){
'use strict';
...
},{"./containers/App":67,"./store/configureStore":71,"react":54,"react-dom":36,"react-redux":46}],71:[function(require,module,exports){
'use strict';
...
function configureStore() {
  ...
  return (0, _redux.createStore)(_ducks2.default, state, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), window.devToolsExtension ? window.devToolsExtension() : function (f) {
    return f;
  }));
}

},{"../ducks":68,"./initialState":72,"redux":61,"redux-thunk":55}],72:[function(require,module,exports){
"use strict";
